...
//        ExecutionContextImpl eci = getEntityFacadeImpl().ecfi.getEci();
        ...
        // TODO: Get rid of L10nFacadeImpl on FieldInfo.convertFromString
//        Object converted = fi.convertFromString(value, eci.l10nFacade);
        Object converted = fi.convertFromString(value);
...
//            for (Entry<String, String> keyValueEntry: relInfo.keyValueMap.entrySet())
...
//    private String makeErrorMsg(String baseMsg, String expandMsg, EntityDefinition ed, ExecutionContextImpl ec) {
    private String makeErrorMsg(String baseMsg, String expandMsg, EntityDefinition ed) {
...
//        if (entityInfo.hasFieldDefaults) checkSetFieldDefaults(ed, ec, null);
        ...
        // TODO: Figure out how to get time for a transaction
...
//            if (doDataFeed(ec)) efi.getEntityDataFeed().dataFeedCheckAndRegister(this, false, valueMapInternal, null);
            ...
            // TODO: Figure out how to seperate transactions from ExecutionContext
...
//            throw new EntitySqlException(makeErrorMsg("Error creating", CREATE_ERROR, ed, ec), e);
            throw new EntitySqlException(makeErrorMsg("Error creating", CREATE_ERROR, ed), e);
        } catch (Exception e) {
//            throw new EntityException(makeErrorMsg("Error creating", CREATE_ERROR, ed, ec), e);
            throw new EntityException(makeErrorMsg("Error creating", CREATE_ERROR, ed), e);
        } finally {
...
//            throw new EntitySqlException(makeErrorMsg("Error updating", UPDATE_ERROR, ed, ec), e);
            throw new EntitySqlException(makeErrorMsg("Error updating", UPDATE_ERROR, ed), e);
        } catch (Exception e) {
//            throw new EntityException(makeErrorMsg("Error updating", UPDATE_ERROR, ed, ec), e);
            throw new EntityException(makeErrorMsg("Error updating", UPDATE_ERROR, ed), e);
        } finally {
            // pop the ArtifactExecutionInfo to clean it up, also counts artifact hit
//            aefi.pop(aei);
        }
...
//            throw new EntitySqlException(makeErrorMsg("Error deleting", DELETE_ERROR, ed, ec), e);
            throw new EntitySqlException(makeErrorMsg("Error deleting", DELETE_ERROR, ed), e);
        } catch (Exception e) {
//            throw new EntityException(makeErrorMsg("Error deleting", DELETE_ERROR, ed, ec), e);
            throw new EntityException(makeErrorMsg("Error deleting", DELETE_ERROR, ed), e);
        } finally {
            // pop the ArtifactExecutionInfo to clean it up, also counts artifact hit
//            aefi.pop(aei);
        }
...
//            throw new EntitySqlException(makeErrorMsg("Error finding", REFRESH_ERROR, ed, ec), e);
            throw new EntitySqlException(makeErrorMsg("Error finding", REFRESH_ERROR, ed), e);
        } catch (Exception e) {
//            throw new EntityException(makeErrorMsg("Error finding", REFRESH_ERROR, ed, ec), e);
            throw new EntitySqlException(makeErrorMsg("Error finding", REFRESH_ERROR, ed), (SQLException) e);
        } finally {
            // pop the ArtifactExecutionInfo to clean it up, also counts artifact hit
//            aefi.pop(aei);
        }
