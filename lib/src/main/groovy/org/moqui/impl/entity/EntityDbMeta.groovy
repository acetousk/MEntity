...
//    static boolean shouldCreateFks(ExecutionContextFactoryImpl ecfi) {
    static boolean shouldCreateFks() {
...
//        if (tablesAdded > 0 && shouldCreateFks(efi.ecfi)) {
        if (tablesAdded > 0 && shouldCreateFks()) {
...
//        }
//
//        String dateStr = new Timestamp(System.currentTimeMillis()).toString() // efi.ecfi.l10n.format(new Timestamp(System.currentTimeMillis()), "yyyyMMdd")
//        int changeSetIdx = 1
