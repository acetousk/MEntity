...
//                    outValue = value; // l10n.parseTimestamp(value, null);
...
//                    if (isEmpty) { outValue = null; break; }
//                    outValue = value; // l10n.parseTime(value, null);
...
//                    if (isEmpty) { outValue = null; break; }
//                    outValue = value; // l10n.parseDate(value, null);
...
//                    break;
                ...
                case 14:
                    if (isEmpty) { outValue = null; break; }
                    Timestamp ts = java.sql.Timestamp.valueOf(value); // l10n.parseTimestamp(value, null);
...
//                    L10nFacadeImpl l10n = ed.efi.ecfi.getEci().l10nFacade;
                    outValue = value.toString(); // l10n.format(value, null);
                    break;
